<template>
    ...
    <button type="button" class="btn btn-primary" data-bs-toggle="modal" :data-bs-target="'#p'+topicos">
Adicionar pergunta
    </button>
    ...
    <div class="modal fade" :id="'p'+topicos" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true" >
        <div class="modal-dialog">
            <div class="modal-content" >
                ...
                <div class="modal-body" >
                    <div alight="right">
                    <button type="button" class="btn btn-primary" data-bs-dismiss="modal" data-bs-toggle="modal" :data-bs-target="'#Up'+topicos" >
                        Adicionar pergunta
                    </button>
                    <button type="button" class="btn btn-primary"  data-bs-dismiss="modal" data-bs-toggle="modal" :data-bs-target="'#cp'+topicos">
        ...
        <div class="modal fade"  :id="'Up'+topicos" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true" >
            <div class="modal-dialog" style="width: 200%">
                <div class="modal-content" >
                    ...
                    <div class="modal-body" >
                        <input type="text" placeholder="pergunta" :id="'pergunta'+topicos"><br>
                        <p :id="'PerguntaError'+topicos"></p>

                        <input type="file" :id="'file' + topicos" class="Pergunta_file">
                        ...
                        <label :for="'tipo'+topicos" >
                            ...
                            <select name="tipo" :id="'tipo'+topicos" @change="alter()">
                        ...
                        <label :for="'tempo'+topicos" >
                            ...
                            <select name="tipo" :id="'tempo'+topicos">
                        ...
                        <label :for="'pontos'+topicos">
                            ...
                            <select name="pontos" :id="'pontos'+topicos" >
                        ...
                        <div :id="'multiple'+topicos" style="margin-top: 20px">
                            ...
                            <div class="input-group mb-3 insertAnsewr" >
                                    ...
                                    <input type='text' :id="'re1'+topicos" class=" form-control" style="border: none;" aria-label="Text input with radio button">
                                    <div class="input-group-text">
                                    <input type="radio" :name="'corret'+topicos"  :value="'re1'+topicos" class="form-check-input">
                                    </div>
                           </div>
                            ...
                            <div class="input-group mb-3 insertAnsewr"  >
                                    ...
                                    <input type='text' :id="'re2'+topicos" class=" form-control" style="border: none" aria-label="Text input with radio button">
                                    <div class="input-group-text">
                                        <input type="radio" :name="'corret'+topicos"  :value="'re2'+topicos" class="form-check-input">
                                    </div>
                             </div>

                            <div class="input-group mb-3 insertAnsewr" >

                                    <input type='text' :id="'re3'+topicos" class=" form-control" style="border: none; " aria-label="Text input with radio button">
                                    <div class="input-group-text">
                                        <input type="radio" :name="'corret'+topicos" :value="'re3'+topicos" class="form-check-input">
                                    </div>
                    </div>
                            ...
                            <div class="input-group mb-3 insertAnsewr" >
                                    ...
                                    <input type='text' :id="'re4'+topicos" class=" form-control" style="border: none; " aria-label="Text input with radio button">
                                    <div class="input-group-text">
                                        <input type="radio" :name="'corret'+topicos"  :value="'re4'+topicos" class="form-check-input">
                                    </div>
                                </div>
                        ...
                        <div :id="'trueFalse'+topicos">
                            true<input type="radio" :name="'TF'+topicos" value="true" class="form-check-input">
                            false<input type="radio" :name="'TF'+topicos" value="false" class="form-check-input">
                            <p :id="'TError'+topicos"></p>
                        </div>
                    <div class="modal-footer">
                        <button type="button" :id="'submit'+topicos" class="btn btn-primary" @click="submit(topicos)">inserir</button>
                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancelar</button>
