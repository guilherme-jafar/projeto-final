<template>
    <div class="section-quizz mt-5 me-md-5 ms-md-5">
                        ...
                        <li class="card-box mb-5 mt-5" v-for="quizz in filter" :key="quizz['id']">
                            ...
                            <div class="mt-2">
                                <div class="collapse mt-2" :id="'collapseQuizz'+quizz['id']">
                                    ...
                                    <div class="text-end d-flex">
                                        <button type="button"
                                                class="btn btn-secondary ms-auto " @click="enterHistorico(quizz['id'])">
                                            Histórico
                                        </button>
                            ...
                            <div class="modal fade" :id="'eliminarQuizz' + quizz['id']" tabindex="-1"
                                ...
                                <div class="modal-dialog modal-dialog-centered">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" :id="'tituloEliminar' + quizz['id']">Eliminar
                                                Quizz</h5>
                                            ...
                                            <form class="row mx-auto" :id="'formEditarQuizz' + quizz['id']">
                                                ...
                                                <div class="col-12 mt-3">
                                                    ...
                                                    <textarea class="form-control" :value="quizz['descricao']"
                                                              :name="'quizzdescricao'+ quizz['id']"
                                                              :id="'quizzdescricao' + quizz['id']"
                                                              rows="2"></textarea>
                                                    ...
                                                    <div :id="'realTime'+ quizz['id']" class="mb-1 mt-5">
                                                        ...
                                                        <div class="mb-1">
                                                            <label>
                                                                <input type="radio" :name="'realtimeop' + quizz['id']"
                                                                       value="true"
                                                                       v-bind:checked="quizz['tipo'] === 'true'"> Sim
                                                            </label>
                                                            <!--                                                        <label v-else>-->
                                                            <!--                                                            <input type="radio" :name="'realtimeop' + quizz['id']"-->
                                                            <!--                                                                   value="true"> Sim-->
                                                        ...
                                                        <div>
                                                            <label>
                                                                <input type="radio" :name="'realtimeop' + quizz['id']"
                                                                       value="false"
                                                                       v-bind:checked="quizz['tipo'] === 'false'">Não
                                                            </label>
                                                            <!--                                                        <label v-else>-->
                                                            <!--                                                            <input type="radio" :name="'realtimeop' + quizz['id']"-->
                                                            <!--                                                                   value="false">Não-->
                                                        ...
                                                        <div class="mb-1">
                                                            <label>
                                                                <input type="radio" :name="'Valepontos' +quizz['id']"
                                                                       value="true"
                                                                       v-bind:checked="quizz['vale_pontos'] === 'true'">
                                                                Sim
                                                            </label>
                                                        </div>
                                                        <div>
                                                            <label>
                                                                <input type="radio" :name="'Valepontos' +quizz['id']"
                                                                       value="false"
                                                                       v-bind:checked="quizz['vale_pontos'] === 'false'">Não
                                                            </label>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div :id="'Visivel'+quizz['id']" class="mb-1 mt-5">
                                                        ...
                                                        <div>
                                                            <label>
                                                                <input type="radio" :name="'Visivelop' + quizz['id']"
                                                                       value="false"
                                                                       v-bind:checked="quizz['visivel'] === 'false'">&nbsp;Não
                                                            </label>
                                                        </div>
                                                ...
                                                <div class="col-12 mt-1">
                                                    <label class="label" :for="'nPerguntas' +quizz['id'] ">Numero
                                                        perguntas</label>
                                                    ...
                                                    <div v-if="topicosQuizz.length !== 0">
                                                        <div class="mb-5 mt-4" v-for="topico in allTopics.data"
                                                            ...
                                                            <div class="card-box-topicos">
                                                                <label class="d-flex "
                                                                       :for="'inputTopico' + topico['id'] + quizz['id']">
                                                                    <h2>
                                                                        {{topico['nome']}}</h2>
                                                                    <input
        ...
        <historico-prof :idQuizz_prop="idQuizzHistorico" :is="component"></historico-prof>
