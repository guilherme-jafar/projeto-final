        ...
        <div v-if="isActive">
            ...
            <div v-else>
                ...
                <div v-else class="section-disciplinas-items">
                    ...
                    <ul>
                        <li class="card-box mb-5 mt-5" v-for="(historico, index) in historicos.data"
                            :key="historico['id']">
                            ...
                            <div>
                                <div class="card-box-text">
                                    ...
                                    <button @click="verTabela(historico['sessaoMaster'])" class="btn btn-secondary">
                                        Ver
                                    </button>
                                </div>
                            </div>
    ...
    export default {
        ...
        methods: {
            getResultsHistoricos(page = 1) {
                ...
                axios.get('/aluno/historico/' + this.idQuiz + '?page=' + page
