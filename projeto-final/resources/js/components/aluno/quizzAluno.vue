                    ...
                    <div v-if="quizz['tipo']==='true'">
                        <div class="card-box-text">
                            ...
                            <button type="button" data-bs-toggle="modal" :data-bs-target="'#p'+quizz['id']"
                                    class="btn btn-secondary ms-2 ms-auto">Fazer Quizz
                            </button>
                        </div>


                        <div class="modal fade" :id="'p'+quizz['id']" tabindex="-1" aria-labelledby="exampleModalLabel"
                             aria-hidden="true">
                            ...
                            <div class="modal-dialog modal-dialog-centered">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <button type="button" class="btn btn-secondary" @click="JoinQuizz(quizz['id'])">
                                            Entrar
                                        </button>
