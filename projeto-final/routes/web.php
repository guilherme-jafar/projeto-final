...
Route::post('/registo/utilizadores', [App\Http\Controllers\ContaController::class, 'register']);
...
Route::group(['middleware' =>['check.auth', 'tipo.utilizador:prof']], function (){
    ...
    Route::get('/prof/Disciplina/{token}', [App\Http\Controllers\Disciplina::class, 'getDiscProf']);
    Route::get('/prof/listTopicos', [App\Http\Controllers\topicos::class, 'getTopicos']);
    ...
    Route::post("/prof/pergunta/create",[App\Http\Controllers\topicos::class,'insertQuestion']);
    Route::get("/getQuizz",[\App\Http\Controllers\Quizz::class,'listQuizz']);
    Route::post("/prof/quizz/create",[App\Http\Controllers\Quizz::class,'insertQuizz']);
    Route::get("/prof/topico/perguntas/{id}",[App\Http\Controllers\topicos::class,'getPerguntas']);
    ...
    Route::get('/prof/historico/{id}', [App\Http\Controllers\Historico::class, 'getHistoricosProf'] );
    Route::get('/prof/historico/sessao/{id}', [App\Http\Controllers\Historico::class, 'getHistoricoSessaoProf'] );
...
Route::group(['middleware' =>['check.auth', 'tipo.utilizador:aluno']], function () {
    ...
    Route::get('/aluno/getRespostas/{id}',[App\Http\Controllers\Quizz::class,'getRespostas']);
    Route::post('/aluno/setResposta',[App\Http\Controllers\Quizz::class,'setResposta']);
...
//    Route::get('/getForum', [App\Http\Controllers\forum::class, 'index']);
    ...
    Route::get('/aluno/historico/{id}', [App\Http\Controllers\Historico::class, 'getHistoricosAluno'] );
    Route::get('/aluno/historico/sessao/{id}', [App\Http\Controllers\Historico::class, 'getHistoricoSessaoAluno'] );
